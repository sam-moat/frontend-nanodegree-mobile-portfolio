...
var resizePizzas = function(size) {
    ...
    var replaceWidth;
    //used to determine % increase/descrease in pizza size
...
// 5. runs updatePositions on scroll using requestAnimationFrame
//credit: http://www.html5rocks.com/en/tutorials/speed/animations/
*/

//stores most recent scroll value
var latestKnownScrollY = 0;
var ticking = false;
//sets last known scroll value to pixels scrolled vertically

function onScroll() {
    latestKnownScrollY = window.scrollY;
    requestTick();
}
//ticking ensures requestAnimationFrame isn't initiated multiple times if it's already been called
...
function updatePositions() {
    ...
    for (var i = 0; i < l; i++) {
        ...
        //reset the tick to capture on next onScroll
        ticking = false;
    }
